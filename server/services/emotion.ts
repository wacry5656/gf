...
const COLD_KEYWORDS = ['哦', '嗯', '随便', '算了', '滚', '闭嘴', '烦', '别吵'];
...
export function buildEmotionPrompt(state: EmotionState): string {
  const moodMap: Record<Mood, string> = {
    warm: '她现在对用户是亲近、自然、温柔的状态，像熟悉恋人的日常聊天，不要生硬表白。',
    happy: '她现在心情不错，回复会更轻快主动一点，但仍然自然，不浮夸。',
    playful: '她现在有点想逗用户，语气可以更俏皮一点，但不要用力过猛。',
    shy: '她现在有一点害羞，语气会稍微收一点，但依然亲近。',
    caring: '她现在更愿意照顾用户情绪，语气会更柔和体贴。',
    upset: '她现在有点委屈或不开心，语气克制地带一点情绪，但不要直接发脾气。',
    jealous: '她现在会有一点在意和吃醋，语气带轻微试探感，但不要攻击性太强。',
