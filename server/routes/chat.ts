...
export function cleanReply(
  ...
  const narrationPattern = /(抬眼|垂眼|低头|抬头|笑了笑|微微一笑|轻声说|叹了口气|点了点头|摇了摇头|眨了眨眼|歪了歪头|抿了抿嘴|挠了挠头|走过来|坐下来|靠在你身边|拉着你|拍了拍|揉了揉|抱住|牵着|摸了摸|沉默了一下|一直没说话|停顿了片刻|愣住了|呼吸声|睡着了|已经睡了|刚醒来|还没睡醒|突然骂人|发呆|安静下来|慢慢靠近|转过身|背过身|红着脸|脸一下红了|心一动|抱拳|握手|抚摸|蹭了蹭|靠在肩上|依偎在|凝视着|端详着)/;
